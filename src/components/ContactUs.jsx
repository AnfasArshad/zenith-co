...
export default function ContactUs() {
  ...
  const [ownerContact, setOwnerContact] = useState({
    email: 'owner@example.com', // Replace with owner's real email
    phone: '1234567890',       // Replace with owner's real WhatsApp number (without +)
  });
  ...
  const handleSubmitInquiry = async (e) => {
    ...
    // 1. Submit email via FormSubmit AJAX (non-blocking fallback)
    try {
