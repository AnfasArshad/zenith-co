    ...
    <div className="app-layout">
      ...
      <div className="promo-bar">
        <div className="container promo-content">
          <span>
            ✨ Zenith Tours Anniversary Sale: Get up to 25% off on select
            flights & car hire.
          </span>
          <button
            className="promo-btn"
      ...
      <footer className="footer-container">
        <div className="footer-content container">
          <div className="footer-brand-column">
            <div className="footer-logo">
              ...
              <span>
                Zenith <span className="text-gradient">Tours</span>
              </span>
            </div>
            <p className="footer-desc">
              Crafting premium travel itineraries, luxury mobility solutions,
              and seamless commercial air ticketing since 2024.
            </p>
            <div className="social-links">
              <a href="#" aria-label="Social Link" className="social-icon-btn">
                <Globe size={18} />
              </a>
              <a href="#" aria-label="Social Link" className="social-icon-btn">
                <Phone size={18} />
          ...
          <div className="footer-links-column">
            ...
            <button
              onClick={() => setActiveTab("air-ticketing")}
              className="footer-link"
            >
              Air Tickets booking
            </button>
          ...
          <div className="footer-news-column">
            ...
            <p>
              Join 15,000+ wanderers who receive our luxury travel guides every
              Friday.
            </p>
            <form
              onSubmit={(e) => {
        ...
        <div className="footer-bottom container">
          <p>
            © {new Date().getFullYear()} Zenith Tours Premium Portal. All rights
            reserved.
          </p>
          <p className="made-with">
            Designed for travelers worldwide with{" "}
